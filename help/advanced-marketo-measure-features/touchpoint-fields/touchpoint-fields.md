...
Hay una herramienta en línea ([[!DNL https]://regex101.com/](https://regex101.com/){target="_blank"}) que permite ejecutar y probar la expresión. La expresión aparece en verde si es válida o en rojo si no lo es. Además, el cuadro [!UICONTROL explicación] de la parte superior derecha es útil y le indica lo que está extrayendo.
