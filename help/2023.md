---
description: Directrices de las notas de la versión 2023 para usuarios de Marketo Measure
...
**Panel de control de tráfico web**

El recién rediseñado [Panel de control de tráfico web](/help/web-traffic-dashboard.md){target="_blank"} ahora es accesible para todos los clientes. Este panel de control ofrece una descripción general completa de las interacciones del visitante del sitio web. Puede analizar métricas como los recuentos de visitantes únicos por URL, las visitas generales, las vistas de página y los envíos de formularios desde direcciones URL de formularios o páginas de destino específicos. También puede realizar un seguimiento de las tendencias de tráfico mensuales e identificar medios de pago de alto rendimiento, lo que le ayudará a refinar sus estrategias para una óptima generación de ingresos.

Está previsto que el nuevo conjunto de paneles de control generados previamente se introduzca por olas, a partir de la primera semana de octubre hasta finales de año.

>[!NOTE]
>
>Aunque los paneles de control actuales quedarán obsoletos para marzo de 2024, puede utilizar ambas versiones hasta entonces, lo que garantiza una transición sin problemas.
...
La tabla URL en la variable [data warehouse](/help/data-warehouse-schema.md){target="_blank"} ahora incluye un campo de título de página, además de tablas de datos web.
...
**Descubrir el rediseño de paneles de control**

Todos los usuarios de Marketo Measure experimentarán nuestros paneles de control en la aplicación rediseñados que combinan una mayor facilidad de uso con un valor añadido. También estamos introduciendo nuevas métricas, como &quot;ROI realizado&quot;, que tiene en cuenta el retraso típico entre las inversiones de marketing y las compras en los mercados de lanzamiento B2B.

Está previsto que el nuevo conjunto de paneles de control generados previamente se introduzca por olas, a partir de la primera semana de octubre hasta finales de año. Estos nuevos paneles de control aparecerán automáticamente en las instancias, junto con información interna del producto y vínculos a la documentación.

* [Nueva guía del panel de control Discover](/help/new-discover-dashboard-guide.md){target="_blank"}
* [Descubra los conceptos básicos del panel de control](/help/discover-dashboard-basics.md){target="_blank"}
* [Panel de control de información general sobre ingresos](/help/revenue-overview-dashboard.md){target="_blank"}
* [Panel de control de ingresos atribuidos](/help/attributed-revenue-dashboard.md){target="_blank"}
* [Panel de control de ROI](/help/roi-dashboard.md){target="_blank"}
* [Panel de control de Passport](/help/passport-dashboard.md){target="_blank"}
...
![Crear nuevos tipos de informes para posibles clientes y contactos con o sin puntos de contacto.](assets/release-notes-3.png)
...
![Quitar campos de FT/LC de cliente potencial/contacto:](assets/release-notes-5.png)

* Añadir campos de Touchpoint:

![Agregar campos de punto de contacto:](assets/release-notes-4.png)
...
![El filtro de posición del punto de contacto y cualquier filtro que utilice los campos FT/LC,](assets/release-notes-2.png)

![El filtro de posición del punto de contacto y cualquier filtro que utilice los campos FT/LC,](assets/release-notes-1.png)
...
* Para mantenerse conectado a Dynamics, instale la última versión del paquete, la 6.12. Ya no se admitirán las versiones antiguas `(<v6.12)`. Esta actualización optimiza la creación de registros históricos para reducir el uso del almacenamiento.

* El método obsoleto de OAuth con un RefreshToken quedará obsoleto. Consulte [esta guía](/help/oauth-with-azure-active-directory-for-dynamics-crm.md){target="_blank"} para actualizar sus credenciales de modo que se ajusten a las prácticas recomendadas de Microsoft para utilizar ClientSecret.
...
Los clientes de Marketo Measure, por primera vez, podrán crear y guardar sus propios informes directamente en la aplicación. Esto seguirá a la publicación de los paneles de control generados previamente a principios de 2024.
...
[Este artículo](/help/configuration-and-setup/salesforce-package-consolidation.md){target="_blank"} incluye guías sobre cómo volver a crear informes y paneles de control a partir de los paquetes de informes heredados.
...
El nuevo vínculo de instalación del paquete consolidado [ se encuentra aquí](https://login.salesforce.com/packaging/installPackage.apexp?p0=04t1P000000VY6Z){target="_blank"}
