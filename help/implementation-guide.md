...
Obtenga más información sobre [Marketo Measure Ultimate](/help/migration-from-tier-to-marketo-measure-ultimate.md){target="_blank"}.
...
![En un origen, seleccione Agregar plantillas de uso de datos](assets/marketo-guide-2.png)

* Seleccione una cuenta y todas las plantillas B2B para crear diez esquemas B2B estándar.

![Seleccione una cuenta y todas las plantillas B2B para crear diez B2B estándar](assets/marketo-guide-3.png)
...
1. Asigne los campos del origen al esquema.
   ...
   >[!NOTE]
   >
   >[Requisito de integridad de datos de Marketo Measure Ultimate](/help/data-integrity-requirement.md){target="_blank"}
...
![Opción 1: para ejecutar consultas directamente desde la interfaz de usuario, acceda a Consultas](assets/marketo-guide-4.png)
...
![Los usuarios pueden asignar etapas desde diferentes orígenes.](assets/marketo-guide-5.png)
