---
description: Describe el tablero Tráfico web para las visitas que los visitantes ven en la página los formularios y el rendimiento del canal a lo largo del tiempo
title: Panel de control de tráfico web
feature: Reporting
...
# Panel de control de tráfico web {#web-traffic-dashboard}
...
| KPI | Definición |
| --- | --- |
| Visitas | El total de visitas al sitio (sesiones) iniciadas desde páginas externas que incluyen usuarios conocidos y anónimos. |
| Visitantes | Número total de visitantes únicos. |
| Page Views | Número total de vistas en páginas del sitio web. |
| Formularios | Número total de envíos de formularios, incluido LinkedIn Lead Gen Forms. |
| Correos electrónicos únicos de Forms | Número total de correos electrónicos únicos de los envíos de formularios. |
| Posibles clientes creados a partir de Forms | Número total de nuevos posibles clientes creados a partir de los envíos de formularios. |
...
![En qué período vio el sitio web el número más alto de Unique](assets/web-dashboard-1.png)
...
![Creación de posibles clientes desde formularios](assets/web-dashboard-2.png)
...
![Visitantes únicos](assets/web-dashboard-3.png)
...
![Cómo se compara la cantidad de visitantes únicos con el total de visitas en](assets/web-dashboard-4.png)
