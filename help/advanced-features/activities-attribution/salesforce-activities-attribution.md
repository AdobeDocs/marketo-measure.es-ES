...
![La pestaña Configuración muestra la página de configuración de actividades para las reglas de atribución](assets/1.png)
...
![Campo Nombre de campaña con ejemplo de parámetro de reemplazo dinámico para Ventas salientes](assets/2.png)
...
![Interfaz de configuración de reglas de actividad que muestra criterios de filtro con las opciones de declaración y/o](assets/3.png)
...
![Selección del campo de fecha de Buyer Touchpoint que muestra las opciones de campo de fecha estándar y personalizadas](assets/4.png)
...
![Selector de tipo de objeto que muestra las opciones de Tareas y Eventos para las reglas de actividad](assets/5.png)
...
![Página de configuración del canal de mercadotecnia que muestra la asignación de campañas con opciones de operador comodín](assets/6.png)
...
![Interfaz de carga de gasto en mercadotecnia para ingresar costos de canal por mes con seguimiento de ROI](assets/7.png)
