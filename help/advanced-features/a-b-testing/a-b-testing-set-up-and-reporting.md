...
1. Edite el diseño de la página de posible cliente y añada la lista relacionada de **[!DNL Marketo Measure]pruebas A/B** a la página.
   ...
   ![Editor de diseño de página de posible cliente que muestra la lista relacionada con las pruebas A/B de Marketo Measure que se está agregando](assets/1.png)
...
1. Haga clic en el botón [!UICONTROL Llave inglesa]. Elimine el campo &quot;Id&quot; de stock de la lista de Campos seleccionados. Añada los campos **[!UICONTROL Experimento]**, **[!UICONTROL Variación]**, y **[!UICONTROL DateReported]**. Cambie de “[!UICONTROL ordenar por]” a **[!UICONTROL fecha del informe]** y seleccione **[!UICONTROL Descendente]** en la lista desplegable.
   ...
   ![Cuadro de diálogo de configuración de campo que muestra los campos Experimento, Variación y Fecha de informe con la configuración de ordenación](assets/2.png)

1. En [!UICONTROL Botones], desmarque **[!UICONTROL Nuevo]**.

   ![Se deseleccionó la sección de botones que muestra el botón Nuevo](assets/3.png)
...
![Lista de informes que muestra tipos de informes de pruebas A/B de Marketo Measure para posible cliente, contacto y oportunidad](assets/4.png)
...
![Ejemplo de informe de Salesforce que muestra la prueba A/B de Marketo Measure con datos de posibles clientes, incluidos experimentos y variaciones](assets/5.png)

Prueba A/B de **[!DNL Marketo Measure]con oportunidad**

![Ejemplo de informe de Salesforce que muestra la prueba A/B de Marketo Measure con datos de oportunidad, incluido el impacto en los ingresos](assets/6.png)
