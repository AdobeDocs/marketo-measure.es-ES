...
La tabla URL en la variable [data warehouse](/help/data-warehouse/data-warehouse-schema.md){target="_blank"} ahora incluye un campo de título de página, además de tablas de datos web.
...
* [Nueva guía del panel de control Discover](/help/marketo-measure-discover-ui/new-discover-dashboard-guide.md){target="_blank"}
...
* [Panel de control de información general sobre ingresos](/help/marketo-measure-discover-ui/revenue-overview-dashboard.md){target="_blank"}
* [Panel de control de ingresos atribuidos](/help/marketo-measure-discover-ui/attributed-revenue-dashboard.md){target="_blank"}
* [Panel de control de ROI &#x200B;](/help/marketo-measure-discover-ui/roi-dashboard.md){target="_blank"}
* [Panel de control de Passport](/help/marketo-measure-discover-ui/passport-dashboard.md){target="_blank"}
...
![Configuración del tipo de informe de Salesforce para posibles clientes/contactos con puntos de contacto](assets/release-notes-2023-1.png)
...
![Columnas del informe que resaltan los campos de cliente potencial heredado y de contacto FT/LC que se van a eliminar](assets/release-notes-2023-2.png)

* Añadir campos de Touchpoint:

![Columnas de informe que muestran los campos de Touchpoint que se van a agregar en lugar de los campos FT/LC](assets/release-notes-2023-3.png)
...
![Ejemplo de configuración del filtro de posición de punto de contacto](assets/release-notes-2023-4.png)

![Filtro de campo de fecha actualizado a campos basados en Touchpoint](assets/release-notes-2023-5.png)
...
[Este artículo](/help/configuration-and-setup/marketo-measure-and-salesforce/salesforce-package-consolidation.md){target="_blank"} incluye guías sobre cómo volver a crear informes y paneles de control a partir de los paquetes de informes heredados.
