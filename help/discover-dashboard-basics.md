...
| Nombre | Descripción |
| --- | --- |
| Botón de alternancia de filtro | Cambie el panel de filtro a abierto o cerrado. |||||||||||||||||||||||||![ — | — |] (apng) |
| Barra de búsqueda | Utilice la búsqueda de la parte superior del panel de filtros para buscar un filtro específico. Cada filtro también tiene su propia barra de búsqueda. ||||||||||||||||||||||||||![ — | — |] (apng) |
| Botón Borrar filtro | Para borrar un filtro, haga clic en el icono de borrador situado en la esquina superior derecha de cada filtro. ||||||||||||||||||||||||||![ — | — |] (apng) |
| Botón Aplicar | Haga clic en para confirmar e implementar los cambios de filtro en el panel. |||||||||||||||||||||![ — | — |] (apng) |
...
![Pase el ratón sobre la esquina superior derecha de un objeto visual para ver una lista de solo lectura de](assets/discover-3b-1.png)
...
![Pase el ratón sobre una imagen para identificar si tiene una jerarquía; la](assets/discover-basics-7.png)
...
![Activar desglose haciendo clic en la flecha hacia abajo, resaltada con un punto gris](assets/discover-basics-8.png)
...
![Para explorar en profundidad un campo a la vez, active la exploración en profundidad](assets/discover-basics-2.gif)

Utilice el icono desplegable de flecha doble para avanzar al siguiente nivel de jerarquía.

![Utilice el icono desplegable de flecha doble para avanzar a la jerarquía siguiente](assets/discover-basics-1.gif)

Utilice el icono de bifurcación para agregar un nivel de jerarquía adicional en la vista actual.

![Use el icono de bifurcación para agregar un nivel de jerarquía adicional en su](assets/discover-basics-12.gif)
...
![Para explorar los datos detrás de la imagen, haga clic con el botón secundario en el elemento visual y](assets/discover-basics-13.gif)
...
![Para acercar un elemento visual o de mosaico específico, pasa el ratón sobre](assets/discover-basics-5.gif)
...
![Si se selecciona un valor o una etiqueta de eje en una visualización, se aplicará el filtro cruzado a otras](assets/discover-basics-3.gif)
