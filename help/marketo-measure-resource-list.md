---
description: Lista de medios [!DNL Marketo Measure] - [!DNL Marketo Measure]
...
* [¿Qué es la atribución de marketing?](/help/marketing-attribution.md)
* [Modelos de atribución de [!DNL Marketo Measure]](/help/attribution-models.md)

**Configuración**

* [Configuración de canal de marketing, práctica recomendada](/help/channel-tracking-and-setup/marketing-channels-and-subchannels.md)
...
* [¿Qué son los parámetros UTM?](/help/channel-tracking-and-setup/utm-parameters.md)
* [Prácticas recomendadas de UTM](/help/channel-tracking-and-setup/best-practices-for-setting-up-utm-parameters.md)
* [Sincronización de campañas de SFDC con puntos de contacto del comprador](/help/channel-tracking-and-setup/campaigns-and-campaign-members.md)
* [Cargando gasto de marketing](/help/marketing-channel-costs.md)
* [Volver a conectar cuentas de publicidad](/help/api-connections/reauthorizing-connected-accounts.md)
* [Agregando [!DNL Marketo Measure] JavaScript](/help/marketo-measure-tracking/adding-marketo-measure-script.md)
   * [Excluir Forms](/help/marketo-measure-tracking/excluding-marketo-measure-from-specific-forms.md)

**Creación de informes**

* [Creación de tipos de informes personalizados con [!DNL Marketo Measure]](/help/marketo-measure-salesforce-reporting/creating-report-types.md) (si necesita crear informes sobre campos personalizados de cliente potencial/contacto/oportunidad)
* [Glosario de  [!DNL Marketo Measure] campos](/help/glossary.md)

**Resolución de problemas**

* [Concediendo  [!DNL Marketo Measure] acceso de soporte técnico a SFDC](/help/salesforce-access.md)
