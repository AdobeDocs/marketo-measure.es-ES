...
* Etiquete automáticamente todos los anuncios de LinkedIn cuyo contenido patrocinado sea del tipo de anuncio con el parámetro necesario [!DNL Marketo Measure] _bl={creativeId}. Este parámetro extrae el ID creativo y permite a [!DNL Marketo Measure] resolver la campaña y la información creativa.
