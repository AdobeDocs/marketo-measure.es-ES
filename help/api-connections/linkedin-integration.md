---
description: Guía de integración de LinkedIn para usuarios de Marketo Measure
...
El contenido patrocinado le permite entregar contenido a la fuente [!DNL LinkedIn] de miembros además de a los que siguen a su compañía. El contenido patrocinado se puede dirigir a una audiencia específica y puede ayudar a los anunciantes a llegar a los miembros de [!DNL LinkedIn] dondequiera y cuando participen en la plataforma [!DNL LinkedIn] en equipos de escritorio, dispositivos móviles y tabletas. Se admite el contenido patrocinado con Forms de generación de posibles clientes.
