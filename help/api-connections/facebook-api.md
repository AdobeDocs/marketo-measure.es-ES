...
![Configurando una nueva conexión de anuncios de Facebook en Marketo Measure](assets/1.gif)
...
![Habilitando el etiquetado automático en la configuración de conexión de Facebook](assets/3.gif)
