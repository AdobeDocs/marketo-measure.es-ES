...
Actualice la memoria sobre cómo cargar información de costes leyendo [este artículo](/help/marketing-spend/marketing-channel-costs.md).
...
Para obtener más información sobre el [!DNL Marketo Measure] Modelo de aprendizaje automático, compruebe [este artículo](/help/advanced-features/custom-attribution-models/machine-learning-model-faq.md).
