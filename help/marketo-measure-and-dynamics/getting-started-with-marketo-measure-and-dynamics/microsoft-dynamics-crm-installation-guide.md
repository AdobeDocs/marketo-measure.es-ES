...
1. A continuación, el [[!DNL Marketo Measure] JavaScript](/help/marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script.md) se debe colocar en todo el sitio y en las páginas de destino. Se recomienda codificar la secuencia de comandos dentro del encabezado de las páginas de destino o añadirla a través de un sistema Tag Management como [Google Tag Manager](/help/marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-via-google-tag-manager.md).
