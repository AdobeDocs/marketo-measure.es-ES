  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
          ...
          <li>
            <strong>Resumen de retorno de la inversión de palabras clave y Creative:</strong>Obsoleto (ver a continuación)</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li>
            <strong>Funnel de cohorte:</strong>Tablero de Recorrido de cohorte</li>
          <li>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <p>
          <strong>Resumen de retorno de la inversión de palabras clave y Creative</strong>
        </p>
      </td>
      <td>
...
* **Tipo de fecha, métrica, Dimension, agrupar por**: esta configuración ahora está predefinida para cada panel para optimizar la entrega de insight. Se puede acceder a los detalles específicos mediante la información sobre herramientas y la documentación adjunta.
* **Fuente de campaña**
* **Nombre e ID de cuenta**: En revisión.

## Nuevas adiciones y mejoras {#new-additions-and-improvements}

Encontrará nuevas características en el artículo [Descubrir conceptos básicos del panel](/help/marketo-measure-discover-ui/discover-dashboard-basics.md){target="_blank"}.
