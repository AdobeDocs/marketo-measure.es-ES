---
description: Guía paso a paso para instalar y configurar el paquete de Marketo Measure en Microsoft Dynamics CRM
...
1. Seleccione [!UICONTROL Credenciales] o [!UICONTROL OAuth].
   ...
   >[!NOTE]
   >
   >Para obtener más información sobre OAuth, visite [este artículo](/help/oauth-with-azure-active-directory-for-dynamics-crm.md). Si tiene alguna pregunta sobre el proceso, póngase en contacto con su Representante de cuentas de [!DNL Marketo Measure].
