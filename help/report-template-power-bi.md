...
![Abra el archivo Power BI de la plantilla de informes de Adobe Marketo Measure.](assets/marketo-bi-1.png)

Puede encontrar la información específica del servidor, data warehouse y el esquema en la interfaz de usuario de [!DNL Marketo Measure] en la página de información de [!DNL Data Warehouse]. [Aquí](/help/data-warehouse-access-reader-account.md){target="_blank"} se detallan las instrucciones para localizar esta página.
...
![Para limitar los datos importados en el modelo, se establece cada tabla](assets/marketo-bi-2.png)
...
![Debido a que los filtros de fecha se aplican a la fecha de modificación de a](assets/marketo-bi-3.png)
...
![La mayoría de las tablas del almacén de datos de Marketo Measure contienen dimensiones desnormalizadas](assets/marketo-bi-7.png)
...
Se ha cambiado el nombre de ![Tablas y columnas para hacerlas más descriptivas y](assets/marketo-bi-5.png)
...
![/pegar funciones y filtrado.](assets/marketo-bi-11.png)
...
![Para agregar capacidades de conversión de moneda a los cálculos del modelo, hemos](assets/marketo-bi-10.png)
...
![La tabla Tasa de conversión almacenada en Snowflake contiene un intervalo de fechas](assets/marketo-bi-9.png)

## Modelo de datos {#data-model}

Haga clic en la imagen siguiente para ver la versión a tamaño completo.

[![Haga clic en la imagen siguiente para ver su versión a tamaño completo.](assets/marketo-bi-12.png)](assets/power-model-1.png){target="_blank"}
...
![Las medidas de conversión de moneda de este modelo sustituyen un valor de 1,0](assets/marketo-bi-13.png)
...
Se han agregado ![definiciones al modelo de Power BI para tablas, personalizado](assets/marketo-bi-15.png)

Se han agregado ![definiciones al modelo de Power BI para tablas, personalizado](assets/marketo-bi-16.png)

Se han agregado ![definiciones al modelo de Power BI para tablas, personalizado](assets/marketo-bi-14.png)

Para ver las definiciones de columnas procedentes directamente de [!DNL Snowflake], consulte la [documentación de data warehouse](/help/data-warehouse-schema.md){target="_blank"}.
