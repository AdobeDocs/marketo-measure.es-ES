---
description: 'Configurando las instrucciones de integración de pruebas A/B para los usuarios de Marketo Measure [!DNL Marketo Measure] '
...
# Configurando la integración de prueba A/B [!DNL Marketo Measure] {#configuring-a-b-testing}
