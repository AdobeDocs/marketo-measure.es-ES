---
description: Guía de campañas y miembros de campaña para usuarios de Marketo Measure
...
![El paquete Marketo Measure Salesforce incluirá un campo denominado](assets/dynamics-lists-1.png)

Las opciones disponibles en la lista desplegable son las siguientes:

![Las opciones disponibles en la lista de selección son:](assets/dynamics-lists-10.png)
...
![Si antes de usar Marketo Measure, usaba una plataforma de automatización de marketing](assets/dynamics-lists-2.png)
...
![Si está habilitado, Marketo Measure insertará un valor de estado en](assets/dynamics-lists-3.png)
...
![La fecha del punto de contacto de actualización masiva está incluida en el Marketo instalado](assets/dynamics-lists-5.png)
...
![Hay una búsqueda que no funciona, la cual se muestra en](assets/legacy-processes-10.png)
...
![Una vez establecida la fecha y la hora, haga clic en Actualizar selección](assets/dynamics-lists-6.png)

## Costes de campaña {#campaign-costs}

Obtenga más información sobre los costes de campaña [en este artículo](/help/crm-campaign-costs.md){target="_blank"}.
