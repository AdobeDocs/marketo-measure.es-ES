...
La segmentación de [!DNL Marketo Measure] le permite definir reglas, que son esencialmente filtros, basados en los campos CRM para agruparlos en segmentos individuales. Estos segmentos estarán disponibles para su uso en los paneles de control de Discover, así como en la creación de informes de [!DNL Salesforce].
...
>[!MORELIKETHIS]
>
>[Cómo configurar la segmentación personalizada](/help/channel-tracking-and-setup/custom-segmentation.md)
