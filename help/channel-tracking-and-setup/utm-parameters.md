---
description: Guía de parámetros de UTM para usuarios de Marketo Measure
...
Obtenga información sobre las [prácticas recomendadas para configurar parámetros UTM](/help/channel-tracking-and-setup/best-practices-for-setting-up-utm-parameters.md).
