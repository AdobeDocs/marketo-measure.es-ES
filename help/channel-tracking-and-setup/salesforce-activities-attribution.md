---
description: Guía de atribución de actividades de Salesforce para usuarios de Marketo Measure
...
![La integración de actividades de Salesforce de Marketo Measure incluye tareas específicas y](assets/activities-attribution-10.png)
...
![Si desea establecer una campaña única para cada representante de ventas](assets/activities-attribution-11.png)
...
![Las reglas actúan como un filtro para indicarnos qué registros son](assets/activities-attribution-12.png)
...
![Con la instalación del paquete, Marketo Measure incluye un Buyer Touchpoint personalizado](assets/activities-attribution-13.png)
...
![No olvide establecer reglas diferentes para Tareas o Eventos. Usted](assets/activities-attribution-5.png)
...
![Y por último, pero no menos importante, tiene la opción de ingresar costos](assets/activities-attribution-9.png)
