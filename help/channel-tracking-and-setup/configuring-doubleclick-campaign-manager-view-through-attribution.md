---
description: Configuración de la vista del Administrador de doble clic de Campaign mediante la guía de atribución para usuarios de Marketo Measure
...
>[!NOTE]
>
>Si está usando la integración de [!DNL Marketo Measure] y [!DNL DoubleClick Campaign Manager], se necesita una [conexión de API](/help/api-connections/integrated-ad-platforms.md) para que podamos descargar detalles de las campañas y los elementos creativos para resolver los anuncios.
...
Para obtener más información sobre la funcionalidad de Atribución de visualización [!DNL Marketo Measure], consulte [Preguntas frecuentes sobre la Atribución de visualización a través de Marketo Measure](/help/channel-tracking-and-setup/marketo-measure-view-through-attribution-faq.md).
...
1. Una vez agregado, confirme que los delimitadores se asignan de la siguiente manera. Debe ser automático una vez que se aplique la etiqueta:
   ...
   ![n = %n Macro de número aleatorio](assets/view-attribution-1.png)
