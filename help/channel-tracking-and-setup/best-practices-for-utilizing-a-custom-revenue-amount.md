...
>[!MORELIKETHIS]
>
>* [Uso de un campo de monto de ingresos personalizado](/help/channel-tracking-and-setup/using-a-custom-revenue-amount-field.md)
>* [Uso del cargador de datos para actualizar el campo de importe personalizado](/help/channel-tracking-and-setup/using-data-loader-to-update-marketo-measure-custom-amount-field.md)
>* [Información general sobre Multi-Currency](/help/channel-tracking-and-setup/overview.md)
>* [Configuración de múltiples monedas](/help/channel-tracking-and-setup/settings.md)
