...
![La hoja de cálculo tiene tres columnas:](assets/offline-channels-1.png)
...
![Los tipos de campañas de SFDC aparecerán en la pestaña del canal sin conexión, enumerados](assets/offline-channels-10.jpg)
...
![Aquí es donde puede crear la asignación de canal/subcanal en](assets/offline-channels-11.png)
...
![En el escenario anterior, querrá crear una campaña única](assets/offline-channels-13.png)
...
Más información sobre [sincronización de campañas sin conexión [!DNL Salesforce] con [!DNL Marketo Measure]](/help/channel-tracking-and-setup/syncing-offline-campaigns.md).
...
![Una vez que haya editado y actualizado la hoja de cálculo con sus reglas personalizadas, la](assets/offline-channels-20.png)
