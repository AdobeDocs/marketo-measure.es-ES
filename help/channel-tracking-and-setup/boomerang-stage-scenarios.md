---
description: Guía de escenarios de boomerang para usuarios de Marketo Measure
...
![El posible cliente 1 se convierte en un contacto con una oportunidad,](assets/boomerang-stages-18.png)
...
![En este escenario, un cliente solo ha elegido realizar el seguimiento de SQL](assets/boomerang-stages-19.png)
...
![En este escenario, un cliente ha elegido rastrear el MQL y](assets/boomerang-stages-21.png)
...
![Todos los puntos de contacto del posible cliente 1 se incluyen en la oportunidad, de](assets/boomerang-stages-22.png)
...
![En este escenario, un cliente ha elegido realizar un seguimiento de MQL, SQL,](assets/boomerang-stages-23.png)
...
![En este escenario, un cliente ha elegido realizar un seguimiento de MQL, SQL,](assets/boomerang-stages-25.png)
...
![En este escenario, un cliente ha elegido rastrear la demostración y](assets/boomerang-stages-25.png)
