---
description: Sincronización de directrices de datos históricos para usuarios de Marketo Measure
...
![Para sincronizar datos en línea históricos, los datos deben estar organizados en Salesforce](assets/dynamics-lists-1.png)
...
![Si los datos están hospedados en otro lugar (por ejemplo, si todavía viven en Marketing](assets/dynamics-lists-10.png)
...
Encontrará más información sobre la sincronización de listas de marketing aquí: [[!DNL Dynamics] Campañas y listas de marketing](/help/channel-tracking-and-setup/dynamics-campaigns-and-marketing-lists.md)
