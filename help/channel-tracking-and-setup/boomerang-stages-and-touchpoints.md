...
>[!NOTE]
>
>[Instrucciones sobre cómo configurar las fases de boomerang](/help/channel-tracking-and-setup/setting-up-boomerang-stages.md).
...
![Sin las fases de Boomerang (el &quot;antes&quot;), solo verá el MQL más reciente](assets/boomerang-stages-18.png)
...
![Utilizando el ejemplo siguiente, esta cuenta de Marketo Measure ha incluido MQL](assets/boomerang-stages-19.png)
