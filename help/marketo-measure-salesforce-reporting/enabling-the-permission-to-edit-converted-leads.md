...
1. Vaya a [!UICONTROL Configuración] y expanda la agrupación [!UICONTROL Administrar usuarios] para seleccionar perfiles.
   ...
   ![1. Vaya a Configuración y expanda la agrupación Administrar usuarios](assets/additional-functionality-1.png)
...
1. Busque el permiso para ver y editar posibles clientes convertidos.
   ...
   ![1. Busque el permiso para ver y editar posibles clientes convertidos.](assets/additional-functionality-2.png)
