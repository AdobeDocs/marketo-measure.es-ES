---
description: Plantilla de informe [!DNL Marketo Measure] - Tableau - [!DNL Marketo Measure]
...
Puede acceder a la plantilla de informe [!DNL Tableau] [aquí](https://github.com/adobe/Marketo-Measure-BI-Templates){target="_blank"}.
...
![Debe actualizar los datos de conexión existentes a su Snowflake específico](assets/marketo-tableau-7.png)

## Conexión de datos {#data-connection}

Debe configurar una conexión de datos con la instancia de Snowflake. Para ello, necesitará el nombre del servidor junto con su nombre de usuario y contraseña. Los detalles sobre dónde encontrar esta información y restablecer su contraseña, si es necesario, están documentados [aquí](/help/data-warehouse-access-reader-account.md){target="_blank"}.

![Debe configurar una conexión de datos con su instancia de Snowflake.](assets/marketo-tableau-5.png)
...
![Para agregar capacidades de conversión de moneda a los cálculos del modelo, hemos](assets/marketo-tableau-4.png)
...
![Hay algunos lugares donde dos tablas de Snowflake tienen](assets/marketo-tableau-3.png)
...
![La columna CATEGORY muestra el número de categoría y la columna SEGMENTNAME](assets/marketo-tableau-13.png)
...
![La otra opción es cambiar el nombre de las columnas directamente en](assets/marketo-tableau-9.png)

## Modelo de datos {#data-model}

Haga clic en la imagen siguiente para ver la versión a tamaño completo.

[![Haga clic en la imagen siguiente para ver su versión a tamaño completo.](assets/marketo-tableau-8.png)](assets/tableau-model-1.png){target="_blank"}
...
![Tanto las dimensiones de Canal y Campaña de uso compartido de datos de Coste y Punto de contacto. Sin embargo, Tableau](assets/marketo-tableau-10.png)
...
![Convertir el valor de moneda corporativa a valor de moneda seleccionado en moneda corporativa](assets/marketo-tableau-11.png)
...
![Las medidas de conversión de moneda de este modelo sustituyen un valor de 1,0](assets/marketo-tableau-12.png)
...
Se han agregado ![definiciones al modelo Tableau para parámetros personalizados](assets/marketo-tableau-15.png)
