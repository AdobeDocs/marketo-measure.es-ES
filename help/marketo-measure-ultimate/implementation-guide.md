...
Ejemplo: Información general de conjuntos de datos: Todos los datos introducidos correctamente en AEP se conservan dentro del lago de datos como conjuntos de datos. Un conjunto de datos es una construcción de almacenamiento y administración para una colección de datos, normalmente una tabla, que contiene un esquema (columnas) y campos (filas).

## Creación de un esquema {#creating-a-schema}

Recomendamos a los clientes que utilicen una utilidad de generación automática para crear 10 esquemas B2B estándar.

Los pasos para descargar y configurar la utilidad se encuentran en la sección &quot;Configuración de la utilidad de generación automática de esquemas y áreas de nombres B2B&quot; en Áreas de nombres y esquemas ExL: B2B

Para clientes con un derecho de CDP: cree esquemas en la página Fuentes
...
Ejemplo: Resumen de flujos de datos
...
ExL: requisito de integridad de datos de Marketo Measure Ultimate
...
Monitorización: página Fuentes → Flujos de datos para comprobar el estado de los flujos de datos. Para ver los detalles de la actividad de un conjunto de datos, simplemente haga clic en él. Para ver los errores de flujo de datos, seleccione un flujo de datos, elija una ejecución de flujo de datos y haga clic en &quot;Previsualización de diagnósticos de error&quot;

## Inspección de datos {#data-inspection}

Ejemplo: Requisito de integridad de datos de Marketo Measure Ultimate Este documento incluye campos obligatorios para cada XDM, así como consultas de inspección. Se publicará en ExL.
...
Opción 2: descargar y utilizar PSQL (más rápido y fiable) ExL: conectar PSQL al servicio de consultas
...
Aspectos a tener en cuenta: los datos de una entidad determinada (por ejemplo, Account) de una fuente determinada solo pueden entrar en un conjunto de datos. Cada conjunto de datos solo puede incluirse en un flujo de datos. Las infracciones detendrán el flujo de datos en tiempo de ejecución.
...
En Measure, la moneda predeterminada debe establecerse en la sección &quot;Moneda&quot;. Si los clientes utilizan varias monedas, el esquema de tasa de conversión de moneda debe rellenarse en AEP para que lo leamos y utilicemos para las conversiones.

Asignación de fases No importamos automáticamente las fases de los datos del cliente, por lo que todas las fases deben asignarse manualmente.
...
Reglas de miembro de campaña Debe elegir un conjunto de datos y establecer reglas para cada uno.

Reglas de eventos de experiencia Debe elegir un conjunto de datos y seleccionar tipos de actividades.
...
Canales sin conexión No hacemos reglas de asignación de canales específicas para conjuntos de datos, por lo que sería global.
