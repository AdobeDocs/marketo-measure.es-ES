...
![Para ver el mensaje de notificación completo en Marketo Measure, haga clic en Ver](assets/adobe-setup-1.png)
...
La documentación de Salesforce sobre los déclencheur de flujo <a href="https://admin.salesforce.com/blog/2023/what-is-a-record-triggered-flow#:~:text=A%20record%2Dtriggered%20flow%20allows,is%20created%20and%2For%20updated">se encuentra aquí</a>.
    ...
    <tr>
      ...
      <td>Error durante la exportación de Crm: CANNOT_INSERT_UPDATE_ACTIVATE_ENTITY : Tipo de entidad 'Posible cliente': Código de error de CRM: CANNOT_INSERT_UPDATE_ACTIVATE_ENTITY, Mensaje de error de CRM: System.LimitException: Se ha superado el límite de tiempo de Apex CPU, RecordId: 0123456
      <p>
      ...
      <td>Revise el código de déclencheur que provoca que la inserción/actualización falle. Consulte la siguiente documentación de Salesforce para obtener más información sobre los déclencheur:
        ...
        <p>
        Proporcione todos los permisos necesarios al <a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">usuario de Marketo Measure</a>.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Consulte el siguiente <a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">artículo de Experience League</a> para obtener instrucciones sobre los permisos que Marketo Measure requiere.</td>
    </tr>
    <tr>
      ...
      <td>Consulte los siguientes artículos de ayuda para garantizar una configuración correcta:
        <ul>
          <li>
            <a href="/help/adobe-analytics.md">Integraciones de Marketo Measure con Adobe Analytics</a>
          </li>
          <li>
    ...
    <tr>
      ...
      <td>Se requieren permisos de lectura y escritura en todos los campos con el prefijo "bizible2__". Se puede encontrar una lista completa de estos campos <a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">en este artículo</a>.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Existen varias razones para este error que son específicas de la organización de Salesforce. A continuación se indican algunos pasos comunes de solución de problemas que pueden resolver el problema:
        <ul>
          <li>Revise todos los permisos que necesitamos para cada <a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">objeto y campo</a>.</li>
    ...
    <tr>
      ...
      <td>Actualice el paquete a la versión más reciente:
        <ul>
          <li> <a href="/help/configuration-and-setup/best-practices-for-marketo-measure-crm-package.md">Prácticas recomendadas</a>
          </li>
