...
1. En la columna de opciones de configuración de la izquierda, haga clic en **[!UICONTROL Conexiones]** ubicadas en la sección [!UICONTROL Integraciones].
   ...
   ![1. En la columna de opciones de configuración de la izquierda, haga clic en](assets/bizible-full-1.png)

1. En la sección CRM de Conexiones, haga clic en **[!UICONTROL Configurar nueva conexión CRM]**.

   ![1. En la sección CRM de Conexiones, haga clic en Configurar nuevo](assets/bizible-taxonomy-1.png)
...
1. Aparece una ventana emergente que le pide que seleccione una conexión CRM. Haga clic en **[!UICONTROL Conectar]** junto al logotipo de [!DNL Salesforce].
   ...
   ![1. Aparece una ventana emergente que le pide que seleccione una conexión CRM. Haga clic](assets/connect-salesforce-1.png)
...
![Puede acceder a este límite en Marketo Measure mediante: Configuración de mi cuenta](assets/connect-salesforce-2.png)
...
1. Haga clic en el icono Bloquear para editarlo.
   ...
   ![1. Haga clic en el icono Bloquear para editar.](assets/connect-salesforce-3.png)

1. Introduzca un límite deseado igual o superior a 100 000. Haga clic en **Guardar** cuando termine.

   ![1. Introduzca un límite deseado igual o superior a 100 000. Haga clic](assets/connect-salesforce-1.png)
