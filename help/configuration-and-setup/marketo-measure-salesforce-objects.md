...
![Los objetos de Marketo Measure están relacionados con objetos de Salesforce estándar específicos. Este(a)](assets/bizible-full-1.png)
...
![El objeto de persona de Marketo Measure relaciona los objetos de cliente potencial y contacto](assets/connect-salesforce-2.png)
...
![Si está ejecutando pruebas A/B mediante Optimizely o VWO (Visual](assets/marketo-salesforce-8.png)
