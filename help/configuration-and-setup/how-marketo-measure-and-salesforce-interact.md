---
description: Información general sobre cómo Marketo Measure intercambia datos con Salesforce, incluidos los permisos de exportación y la configuración por lotes
...
![Si no instaló el paquete de Marketo Measure Salesforce,](assets/bizible-full-1.png)
...
![De manera predeterminada, Marketo Measure exporta 200 registros por crédito de API cada uno](assets/bizible-taxonomy-1.png)
