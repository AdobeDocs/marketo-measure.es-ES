...
1. En la columna de opciones de configuración de la izquierda, haga clic en **[!UICONTROL Conexiones]** ubicadas en la sección [!UICONTROL Integraciones].
   ...
   ![Menú de configuración que muestra la opción Conexiones en la sección Integraciones](assets/connect-marketo-measure-to-salesforce-1.png)

1. En la sección CRM de Conexiones, haga clic en **[!UICONTROL Configurar nueva conexión CRM]**.

   ![Página Conexiones CRM con el botón Configurar nueva conexión CRM](assets/connect-marketo-measure-to-salesforce-2.png)
...
1. Aparece una ventana emergente que le pide que seleccione una conexión CRM. Haga clic en **[!UICONTROL Conectar]** junto al logotipo de [!DNL Salesforce].
   ...
   ![Seleccione la ventana emergente de conexión de CRM con el logotipo de Salesforce y el botón Conectar](assets/connect-marketo-measure-to-salesforce-3.png)
...
![Ajuste diario de límite de API de CRM que muestra el campo de configuración para la cuota de crédito de API](assets/connect-marketo-measure-to-salesforce-4.png)
...
1. Haga clic en el icono Bloquear para editarlo.
   ...
   ![Icono de bloqueo para editar el campo Límite diario de API de CRM](assets/connect-marketo-measure-to-salesforce-5.png)

1. Introduzca un límite deseado igual o superior a 100 000. Haga clic en **Guardar** cuando termine.

   ![Campo de entrada de límite diario de API de CRM con valor introducido y botón Guardar](assets/connect-marketo-measure-to-salesforce-6.png)
