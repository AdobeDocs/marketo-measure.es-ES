...
![A continuación se muestra un diagrama de flujo que representa el modo en que Marketo Measure Custom](assets/bizible-full-1.png)

Para la imagen de tamaño completo, [haga clic aquí](assets/bizible-full-1.png).
