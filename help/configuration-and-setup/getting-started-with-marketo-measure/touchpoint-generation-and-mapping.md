...
> [Sincronizando campañas CRM desde SFDC](/help/channel-tracking-and-setup/offline-channels/legacy-processes/syncing-offline-campaigns.md)
> [Sincronizando campañas CRM desde  [!DNL Marketo Measure]](/help/channel-tracking-and-setup/offline-channels/custom-campaign-sync.md)
> [Asignando campañas CRM a  [!DNL Marketo Measure] canales/subcanales](/help/channel-tracking-and-setup/offline-channels/offline-custom-channel-setup.md)
> [Creando puntos de contacto a partir de actividades de ventas](/help/advanced-features/activities-attribution/salesforce-activities-attribution.md)
> [Preguntas frecuentes sobre actividades y asignación de puntos de contacto de actividades a canales o subcanales](/help/advanced-features/activities-attribution/activities-attribution-faq.md)
