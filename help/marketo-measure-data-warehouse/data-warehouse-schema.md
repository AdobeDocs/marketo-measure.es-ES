---
description: Referencia para el esquema de Marketo Measure Data Warehouse que detalla tablas y columnas
...
<table>
  <tbody>
    ...
    <tr>
      <td>ID</td>
      <td>varchar</td>
      <td>Un id. único para el anuncio.</td>
      <td>fb.106851586409075.6052044288804.6052044290004.6053457066804</td>
    </tr>
    <tr>
      <td>DISPLAY_ID</td>
      <td>varchar</td>
      <td>El id. de anuncio, desde el sistema de origen.</td>
      <td>6053457066804</td>
    </tr>
    <tr>
      <td>AD_ACCOUNT_UNIQUE_ID</td>
      <td>varchar</td>
      <td>El id. de la cuenta de anuncios desde la que se importó el anuncio.</td>
      <td>fb.106851586409075</td>
    </tr>
    <tr>
      <td>AD_ACCOUNT_NAME</td>
      <td>varchar</td>
      <td>El nombre de la cuenta de anuncios desde la que se importó el anuncio.</td>
      <td>[!DNL Marketo Measure] Cuenta</td>
    </tr>
    <tr>
      <td>ADVERTISER_UNIQUE_ID</td>
      <td>varchar</td>
      <td>El id. del anunciante para el anuncio, específicamente para DoubleClick.</td>
      <td>300181641</td>
    </tr>
    <tr>
      <td>ADVERTISER_NAME</td>
      <td>varchar</td>
      <td>El nombre del anunciante del anuncio, específicamente para DoubleClick.</td>
      <td>Marketing Analytics</td>
    </tr>
    <tr>
      <td>AD_GROUP_UNIQUE_ID</td>
      <td>varchar</td>
      <td>El id. del grupo de anuncios para el anuncio.</td>
      <td>fb.106851586409075.6052044288804.6052044290004</td>
    </tr>
    <tr>
      <td>AD_GROUP_NAME</td>
      <td>varchar</td>
      <td>El nombre del grupo de anuncios para el anuncio.</td>
      <td>Conjunto de anuncios para el anuncio B</td>
    </tr>
    <tr>
      <td>AD_CAMPAIGN_UNIQUE_ID</td>
      <td>varchar</td>
      <td>El id. de la campaña para el anuncio.</td>
      <td>fb.106851586409075.6052044288804</td>
    </tr>
    <tr>
      <td>AD_CAMPAIGN_NAME</td>
      <td>varchar</td>
      <td>El nombre de la campaña del anuncio.</td>
      <td>Campaña de generación de posibles clientes</td>
    </tr>
    <tr>
      <td>IS_ACTIVE</td>
      <td>boolean</td>
      <td>Indica si el anuncio sigue activo o no en el sistema de origen.</td>
      <td>false</td>
    </tr>
    <tr>
      <td>IS_DELETED</td>
      <td>boolean</td>
      <td>Indica si el anuncio se ha eliminado o no en el sistema de origen.</td>
      <td>false</td>
    </tr>
    <tr>
      <td>MODIFIED_DATE</td>
      ...
      <td>02/08/2018 06:35:59,000</td>
    </tr>
    <tr>
      <td>FIRST_IMPORTED</td>
      <td>timestamp_ntz</td>
      <td>La fecha en la que se importó por primera vez el registro desde el sistema de origen.</td>
      <td>02/08/2018 06:35:59,000</td>
    </tr>
    <tr>
      <td>NAME</td>
      <td>varchar</td>
      <td>El nombre del anuncio, desde el sistema de origen.</td>
      <td>Anuncio 2</td>
    </tr>
    <tr>
      <td>NEEDS_UPDATE</td>
      <td>boolean</td>
      <td>Indica si el anuncio debe actualizarse o no para el etiquetado de [!DNL Marketo Measure].
      <p>(Campo de diagnóstico, utilizado para el procesamiento interno).
      </td>
      <td>false</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>ENTITY_TYPE</td>
      <td>varchar</td>
      <td>El objeto o entidad principal de esta tabla. En este caso, “Anuncio”.</td>
      <td>Anuncio</td>
    </tr>
    <tr>
      <td>PROVIDER_TYPE</td>
      <td>varchar</td>
      <td>El nombre del proveedor de anuncios para el anuncio.</td>
      <td>Facebook</td>
    </tr>
    <tr>
      <td>URL_CURRENT</td>
      <td>varchar</td>
      <td>La dirección URL de la página de destino.
        <p>(Campo de diagnóstico, para procesamiento interno).
      </td>
      <td></td>
    </tr>
    <tr>
      <td>URL_OLD</td>
      <td>varchar</td>
      <td>Valor anterior para URL_CURRENT.
      <p>(Campo de diagnóstico, para procesamiento interno).
      </td>
      <td></td>
    </tr>
    <tr>
      <td>URL_REQUESTED</td>
      <td>varchar</td>
      <td>Decoración de la dirección URL con los parámetros de [!DNL Marketo Measure].
      <p>(Campo de diagnóstico, para procesamiento interno).
      </td>
      <td></td>
    </tr>
    <tr>
      ...
      <td>varchar</td>
      <td>Importado desde el sistema de origen.
      <p>(Campo de diagnóstico, para procesamiento interno).
      </td>
      <td></td>
    </tr>
...
<table>
  <tbody>
    ...
    <tr>
      <td>ID</td>
      <td>varchar</td>
      <td>Un id. único para el anunciante.</td>
    ...
    <tr>
      <td>ADVERTISER_UNIQUE_ID</td>
      <td>varchar</td>
      <td>El id. del anunciante, específicamente para DoubleClick.</td>
      <td>300181641</td>
    </tr>
    <tr>
      <td>ADVERTISER_NAME</td>
      <td>varchar</td>
      <td>El nombre del anunciante, específicamente para DoubleClick.</td>
      <td>[!DNL Marketo Measure] Marketing Analytics</td>
    </tr>
    <tr>
      <td>AD_GROUP_UNIQUE_ID</td>
      <td>varchar</td>
      <td>Se espera que sea nulo, ya que no hay ningún grupo de anuncios por encima del anunciante en ninguna jerarquía de anuncios.</td>
      <td>nulo</td>
    </tr>
    <tr>
      <td>AD_GROUP_NAME</td>
    ...
    <tr>
      <td>AD_CAMPAIGN_UNIQUE_ID</td>
      <td>varchar</td>
      <td>Se espera que sea nulo, ya que no hay ninguna campaña de anuncios por encima del anunciante en ninguna jerarquía de anuncios.</td>
      <td>nulo</td>
    </tr>
    <tr>
      <td>AD_CAMPAIGN_NAME</td>
      <td>varchar</td>
      <td>Se espera que sea nulo, ya que no hay ninguna campaña por encima del anunciante de anuncios en ninguna jerarquía de anuncios.</td>
      <td>nulo</td>
    </tr>
    <tr>
      <td>IS_ACTIVE</td>
      <td>boolean</td>
      <td>Indica si el anunciante sigue activo o no en el sistema de origen.</td>
      <td>true</td>
    </tr>
    <tr>
      <td>IS_DELETED</td>
      <td>boolean</td>
      <td>Indica si el anunciante se ha eliminado o no en el sistema de origen.</td>
      <td>false</td>
    </tr>
    <tr>
      <td>MODIFIED_DATE</td>
    ...
    <tr>
      <td>NAME</td>
      <td>varchar</td>
      <td>El nombre del anunciante, desde el sistema de origen.</td>
      <td>[!DNL Marketo Measure] Marketing Analytics</td>
    </tr>
    <tr>
      <td>NEEDS_UPDATE</td>
      <td>boolean</td>
      <td>Indica si el anunciante debe actualizarse o no para el etiquetado de [!DNL Marketo Measure].
      <p>(Campo de diagnóstico, utilizado para el procesamiento interno).
      </td>
      <td>false</td>
    </tr>
    ...
    <tr>
      <td>ENTITY_TYPE</td>
      <td>varchar</td>
      <td>El objeto o entidad principal de esta tabla. En este caso, “Anunciante”.</td>
      <td>Anunciante</td>
    </tr>
    <tr>
      <td>PROVIDER_TYPE</td>
      <td>varchar</td>
      <td>El proveedor de anuncios para el anunciante.</td>
      <td>DoubleClick</td>
    </tr>
    <tr>
      <td>ROW_KEY</td>
...
<tbody>
  ...
  <tr>
    ...
    <td>varchar</td>
    <td>id de cuenta original de MM para el evento de conversión</td>
    <td>0013100001kpAZxAAM</td>
  </tr>
  <tr>
    <td>CONVERSION_OPPORTUNITY_ID</td>
    <td>varchar</td>
    <td>ID de oportunidad original de MM para el evento de conversión</td>
  ...
  <tr>
    ...
    <td>varchar</td>
    <td>ID de contacto MM original para el evento de conversión
    <br>probablemente sea nulo la mayor parte del tiempo</td>
    <td>00331000032hMxRAAU</td>
  </tr>
  <tr>
    <td>CONVERSION_EVENT_TYPE</td>
    <td>varchar</td>
    <td>tipo de evento de conversión (b2b = conversión de posible cliente, b2c = conversión de oportunidad)</td>
    <td>b2b</td>
  </tr>
  <tr>
    <td>SCORE_DATE</td>
    <td>Timestamp_ntz</td>
    <td>fecha en la que se anotaron los puntos de contacto por última vez</td>
    <td>01/01/2020 01:01:00,000</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Timestamp_ntz</td>
    <td>la fecha de transición del punto de contacto o la fase</td>
    <td>01/01/2020 01:01:00,000</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>AAI_SOURCE_ID</td>
    <td>varchar</td>
    <td>clave externa de la tabla de fuentes de inteligencia artificial aplicada a la atribución</td>
    <td> </td>
  </tr>
  <tr>
    <td>_CREATED_DATE</td>
    <td>Timestamp_ntz</td>
    <td>fecha de creación del registro en Snowflake</td>
    <td>01/01/2020 01:01:00,000</td>
  </tr>
  <tr>
    <td>_MODIFIED_DATE</td>
...
<table>
  <tbody>
    ...
    <tr>
       <td>ID</td>
      <td>varchar</td>
      <td>El id. de miembro de campaña, desde el sistema de origen.</td>
...
>[!IMPORTANT]
>
>Marketo Measure dejará de utilizar esta tabla a mediados de 2024. Si desea crearla por su cuenta, ejecute [esta consulta SQL](/help/marketo-measure-data-warehouse/assets/BIZ_FACTS.sql).
...
<table>
  <tbody>
    ...
    <tr>
      <td>ID</td>
      <td>varchar</td>
      <td>La dirección URL completa.</td>
      <td>https://www.adobe.com/blog/strategic-marketing-plangoals</td>
    </tr>
    <tr>
      <td>SCHEME</td>
      <td>varchar</td>
      <td>Comunicación segura de la página web a través de la red.</td>
      <td>https</td>
    </tr>
    <tr>
      <td>HOST</td>
      <td>varchar</td>
      <td>El dominio de la dirección URL, con cualquier subdominio.</td>
      <td>www.adobe.com</td>
    </tr>
    <tr>
      <td>PAGE_TITLE</td>
      ...
      <td>Guía de CMO para la descarga de atribución de marketing B2B</td>
    </tr>
    <tr>
      <td>PATH</td>
      <td>varchar</td>
      <td>La parte de la dirección URL que señala a una ubicación específica del host.</td>
      <td>/blog/strategic-marketing-plangoals</td>
    </tr>
    <tr>
      <td>PORT</td>
      <td>varchar</td>
      <td>El puerto de un host de Internet, opcional en una URL.</td>
      <td>584</td>
    </tr>
    <tr>
      <td>ROW_KEY</td>
