---
description: Atribución de marketing
...
**Atribución de marketing** es el proceso de asignación de crédito de ingresos a un punto de contacto de marketing. Esto se realiza con el seguimiento de todo el recorrido del cliente potencial, desde la primera interacción con su empresa hasta el momento en que se cierra el acuerdo. Los ingresos generados por el acuerdo se atribuyen a los Touchpoints de marketing que impulsaron a la venta. El importe de crédito de ingresos que se le ha proporcionado a un punto de contacto depende de la influencia que ese punto de contacto haya tenido en la decisión de compra del cliente.
...
![Los puntos de contacto hacen referencia a las interacciones que un cliente potencial/posible cliente tiene con su proveedor en línea o](assets/overview-resources-8.png)
